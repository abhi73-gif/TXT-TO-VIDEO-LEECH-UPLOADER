        ...
        if FORCE_SUB_CHANNEL:
            ...
            if not is_sub:
                keyboard = InlineKeyboardMarkup([
                    [InlineKeyboardButton("🔔 Join Channel", url="https://t.me/updatechannal123")],
...
async def start(bot: Client, m: Message):
    ...
    keyboard = InlineKeyboardMarkup([
        ...
        [
            InlineKeyboardButton("🔔 Channel", url="https://t.me/updatechannal123"),
            InlineKeyboardButton("👨‍💻 Developer", url="https://t.me/BIHARICHATING_BOT")
        ]
    ])
